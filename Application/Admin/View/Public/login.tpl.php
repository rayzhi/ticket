...
<body>
        ...
        <div class="panel panel-default login-panel border-none padding-none col-xs-12 col-md-4 col-md-offset-4">
            ...
            <div class="panel-body">
                <form class="login-form" action="<?php echo UC('Admin/Public/postLogin');?>" method="post">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon bg-none"><i class="fa fa-tags"></i></span>
                             <input type="text" autocomplete="off" id="verify" name="captcha" class="form-control" placeholder="请输入验证码" errormsg="请填写5位验证码" nullmsg="请填写验证码" datatype="*5-5" name="verify">
                      
                        </div>
                    </div>
                    <img id="captchaImg" src="<?php echo UC('Admin/Public/captcha'); ?>" onclick="freshCaptcha()" border="0" alt="点击刷新验证码" style="cursor: pointer; height: 40px; width: 225px;" align="absmiddle">
	...
	function freshCaptcha(){ 
		...
		$('#captchaImg').attr('src', '<?php echo UC('Admin/Public/captcha'); ?>?'+timenow);
	}
